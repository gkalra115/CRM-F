$.ajax({
  type: 'GET',
  url: '/bdm/task/delayed?count=yes',
...
$.ajax({
  type: 'GET',
  url: '/bdm/task/progress?count=yes',
  success: function (data) {
...
$.ajax({
  type: 'GET',
  url: '/bdm/task/unassigned?count=yes',
  success: function (data) {
    $('.demo').hide('fast');
...
function dashboardTopVendorSales(value) {
  ...
  if ((cMonth === 'EOT', gMonth === 'EOT', cYear === 'EOT')) {
    ...
    apiUrl = `/bd/sales?month=${cMonth}&year=${cYear}`;
...
function dashboardTopVendorFinance(value) {
  ...
  if ((cMonth === 'EOT', gMonth === 'EOT', cYear === 'EOT')) {
    ...
    apiUrl = `/bd/finance?month=${cMonth}&year=${cYear}`;
    $('#FinanceSummary').text(
