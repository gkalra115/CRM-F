...
var KTDatatablesUnApprovedOrders = (function () {
  var initTable4 = function () {
    ...
    var table = $('#kt_table_4').DataTable({
      ...
      searchDelay: 500,
      ajax: {
        url: '/client/task/un-approved-order',
        type: 'GET',
        data: {
        ...
        },
        {
          ...
          render: function (data) {
            var status = {
              ...
              Rejected: { title: 'Rejected', class: ' kt-badge--primary' },
            };
            return (
              '<span class="kt-badge ' +
...
jQuery(document).ready(function () {
  KTDatatablesUnApprovedOrders.init();
});
