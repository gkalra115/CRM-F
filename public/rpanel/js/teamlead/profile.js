var TeamleadAccountForm = $('#tl-account-form');
var TeamleadChangePasswordForm = $('#tl-change-password');

TeamleadChangePasswordForm.validate({
  rules: {
    oldPassword: {
      required: true,
      minlength: 8,
