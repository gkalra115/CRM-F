  ...
  var initTable3 = function () {
    ...
    table = $('#kt_table_3').DataTable({
      ...
      ajax: {
        ...
        type: 'GET',
        data: {
          columnsDef: ['email', 'name', 'phone', 'user_role', 'is_active'],
        },
      },
      columns: [
        { data: 'email' },
      ...
      columnDefs: [
          ...
          render: function (data, type, full, meta) {
            ...
            switch (data) {
              case 'Super':
                return (
                  additionalData +
                  '<span id="user_role" class="kt-badge kt-badge--inline kt-badge--pill" style="background-color:#000; color:#fff;">Super</span>'
                );
              case 'Admin':
                return (
                  additionalData +
              ...
              case 'BDM':
                return (
                  additionalData +
                  '<span id="user_role" class="kt-badge kt-badge--inline kt-badge--inline kt-badge--pill"  style="background-color:#3cd; color:#fff;">' +
                  data +
                  '</span>'
                );
            }
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var status = {
              1: { title: 'Deactivated', state: 'danger' },
    ...
    $('#kt_form_status').on('change', function () {
      ...
      console.log(val);
      table.ajax.url(`/api/employee/view?action=${val}`).load();
