...
var ExpertAccountForm = $('#ex-account-form');
var ExpertChangePasswordForm = $('#ex-change-password');

ExpertChangePasswordForm.validate({
  rules: {
    oldPassword: {
      required: true,
      minlength: 8,
