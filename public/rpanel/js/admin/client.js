...
const toggleClientCanvas = (id) => {
  ...
  $.ajax({
    ...
    url : `/api/client/${id}`,
    success : function(data){
      let { _id, name, phone, email, is_active, client} = data
      ...
      $("#clientdetails").attr("href", "client/"+ $('#kt-widget_clientid').text());
