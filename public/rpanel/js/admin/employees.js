...
const createEmployee = (id = undefined, rowindex) => {
    ...
    if (id === undefined) {
      ...
      $.ajax({
        type: "PUT",
        url: "/admin/employee/" + employeeData.id,
        data: employeeData, // serializes the form's elements.
        success: function(data) {
          if (data.msg === "error") {
            return showEmployeeErrorMsg(
  ...
  const editEmployee = (id, rowindex) => {
    ...
    $.ajax({
      ...
      success : function(data){
        ...
        $("#createEmployee #joiningDate").val(employee.joiningDate.split("T")[0]),
  ...
  const toggleEmployeeCanvas = (id, rowindex) => {
    ...
    $.ajax({
      ...
      success : function(data){
        ...
        $("#kt-widget__subtitle_jDate").empty().append(datecovert(employee.joiningDate))
