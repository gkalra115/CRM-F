    ...
    var demo6 = function() {
        $("#kt_tree_6").jstree({
            "core" : {
                ...
                'data' : {
                    'url' : function (node) {
                      return '/admin/employee/tree';
                    },
                    'data' : function (node) {
                      return { 'parent' : node.id === "#" ? $("#treeViewCallId").text() : node.id };
                    },
                    'cache':false,
                }
            },
                    ...
                    return {
                                    ...
                                    success : function(data){
                                        ...
                                        $("#assignTo").empty()
                                         data.getAboveHierarchy.forEach((obj) => {
                                            $("#assignTo").append(`<option value="${obj._id}">${obj.name} [${obj.employee.user_role}]</option>`) 
                                        })
                        ...
                        "Edit" : {
                            ...
                            action : function (obj) {
                                $.ajax({
                                    method : "GET",
                                    url : '/admin/employee/' +  (obj.reference[0].id).split("_")[0],
                                    success : function(data){
