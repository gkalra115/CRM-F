...
var KTBootstrapDaterangepicker = function () {
    ...
    var demos = function () {
        ...
        $('#kt_daterangepicker_2').daterangepicker({
            ...
            displayFilteredTable($("#changePage").text(), $("#hideSelect").text(), start.format('YYYY/MM/DD')+'|'+end.format('YYYY/MM/DD'))
            iniDatePickerOnCall()
            KTApp.unblock("body");
        });
