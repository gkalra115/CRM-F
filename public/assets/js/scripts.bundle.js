...
//   //     `${
//   //       $('.kt-notification__item.checkCount').length -
//   //       $('.kt-notification__item.notificationRead').length
//   //     }`
//   //   );
//   $('.checkBoxNotificationRead').click(function () {
//     if ($(this).hasClass('notificationRead')) {
//       return toastr.warning('Notification already read!!');
//     }
//     readNotification($(this).attr('data-id'));
//     $(this).addClass('notificationRead');
//     // $('#notificationsCount').text(
//     //   `${
//     //     $('.kt-notification__item.checkCount').length -
//     //     $('.kt-notification__item.notificationRead').length
...
//   $('.checkBoxNotificationUnRead').click(function () {
//     unReadNotification($(this).attr('data-id'));
//     getAllNotification();
//   });
// };
...
function notifyMe(message) {
  return;
  // const myAudio = new Audio('/assets/sound/notification.mp3');
...
$(document).ready(function () {
  ...
  socket.on('taskCreation', (data) => {
    // $('#taskNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}" target="blank"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
  ...
  socket.on('taskStatusUpdated', (data) => {
    // $('#taskNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
    notificationUpdateCount();
    notifyMe(data.title + '\n' + data.subTitle);
    toastr.success(data.title + '\n' + data.subTitle);
  ...
  socket.on('taskSolutionUpload', (data) => {
    // $('#taskNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
    notificationUpdateCount();
  ...
  socket.on('taskSolutionSentClient', (data) => {
    // $('#taskNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
    notificationUpdateCount();
  ...
  socket.on('taskPaymentUpdate', (data) => {
    // $('#taskNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
    notificationUpdateCount();
  ...
  socket.on('taskCommentCreate', (data) => {
    // $('#taskNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
    notificationUpdateCount();
  ...
  socket.on('taskClientCreate', (data) => {
    // $('#userNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
    notificationUpdateCount();
    notifyMe(data.title + '\n' + data.subTitle);
  ...
  socket.on('taskEmployeeCreate', (data) => {
    // $('#userNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
    notificationUpdateCount();
  ...
  socket.on('taskEmployeeEdit', (data) => {
    // $('#userNotification').prepend(
    //   `<a class="kt-notification__item" href="${data.action}"><div class="kt-notification__item-icon"><i class="flaticon2-line-chart kt-font-success"></i></div><div class="kt-notification__item-details"><div class="kt-notification__item-title">${data.title}</div><div class="kt-notification__item-time">${data.subTitle}</div></div></a>`
    // );
    notificationUpdateCount();
...
var KTChat = (function () {
  var initChat = function (parentEl) {
    ...
    var handleMessaging = function () {
      ...
      var usertextinput = {userinput:textarea.value}
      console.log(usertextinput)
      $.ajax({
        type: 'PUT',
        url: '/su/api/v1/aitools/chatbot',
        data: usertextinput,
        success: function (data) {
          var node = document.createElement('DIV');
          KTUtil.addClass(node, 'kt-chat__message kt-chat__message--success');
          console.log(data)
          var messageoslo = data.replace('OSLO: ','')
          var html =
            '<div class="kt-chat__user">' +
            '<a href="#" class="kt-chat__username">Oslo</span></a>' +
            '<span class="kt-chat__datetime">Just now</span>' +
            '</div>' +
